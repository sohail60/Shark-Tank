                ...
                <div className="col">
                    <form action="" className="mx-auto">
                        ...
                        <div className="mb-3">
                            ...
                            <input className="form-control" list="datalistOptions" id="exampleDataList" placeholder="Enter City"/>
                        ...
                        <div className="mb-3">
                            <label for="plans" className="form-label">Give us your Message</label>
                            <textarea className="form-control" id="plans" rows="3"></textarea>
                        </div>
